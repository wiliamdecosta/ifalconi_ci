    ...
    function read() {
    	...
    	try {
		    ...
		    if(!empty($searchPhrase)) {
		        $table->setCriteria("(user_loket.user_name ".$table->likeOperator." '%".$searchPhrase."%' OR user_loket.full_name ".$table->likeOperator." '%".$searchPhrase."%')"); 
		    }
