...
class P_application_role extends Abstract_model {
	...
	public $fromClause 		= "p_application_role as application_role
	                                LEFT JOIN p_application as application ON application_role.p_application_id = application.p_application_id";
